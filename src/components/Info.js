    ...
    return (
        ...
        <Nav />
          ...
          <div className="Page-text">
            ...
            <p>The title of your new routine will display in <strong>My Routines</strong>. Select the routine you want to practice. Then select the title of the drill you want to try and click <strong>Enter Score</strong> to record your results. Enter the number of attempts and how many points you made according to the scoring instructions for that drill.</p>
